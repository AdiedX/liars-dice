...
const LiarsDice = function ( noOfPlayers ) {
...
LiarsDice.prototype = {
  ...
  move: function ( player, diceCount, value ) {
    ...
    let message = 'Player ' + player + ' put ' + diceCount + ' ' + value + '\'s on the table';
   ...
   */
  challenge: function () {
    const claim = this._claims.pop();
    const diceCount = claim.diceCount;
